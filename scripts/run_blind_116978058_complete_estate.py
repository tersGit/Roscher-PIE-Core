#!/usr/bin/env python3
"""Blind ranking of Property24 116978058 against carlswald_north_corrected_002.

Distinctive pool-shape stress test using the exact frozen stack from
PR #18, #19 and #20. Phase 1 writes freeze.json before any stand/address lookup.
Prior 116978058 artifacts are excluded from ranking input; Hybrid is extracted fresh.
"""
...
LISTING_URL = (
    "https://www.property24.com/for-sale/carlswald-north-estate/midrand/gauteng/12743/116978058"
)
OUT_DIR = ROOT / "data/investigations/blind_116978058_complete_estate"
